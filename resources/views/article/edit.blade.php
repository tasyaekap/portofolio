						...
						<div class="post_comment">
							<div class="contact_form_container">
								<form action="{{route('article.update', $article->id)}}" method="POST">
                                    ...
                                    <input type="text" name="title" id="title" class="contact_input contact_input_name" value="{!!$article->title!!}"required="required">
									<textarea class="contact_text" name="content" id="content " required="required">{!!$article->content!!}</textarea>
